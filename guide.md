...
- Click the [`Scan Qr`](https://replit.com/@ahil15/XLICON-Multi-qr?v=1) from ***BelugaBot-MD*** Repository
...
- Click the [`heroku-Deploy`](https://heroku.com/deploy?template=https://github.com/ahil15/Xlicon-v2) option in ***BelugaBot-MD*** repository
