...
//
  ...
  /*  let buttons = [
   ...
   /* footer: `${BotName}`,
    ...
    mediaUrl: 'github.com/ahil15/BelugaBot-MD',
    sourceUrl: "github.com/ahil15/BelugaBot-MD"
    }}
...
A17.sendMessage(from, {video:{url:ytmp4play2.videoUrl}, mimetype:"video/mp4", caption:'Downloaded by *Bᴇʟᴜɢᴀ-Bᴏᴛ*',}, {quoted:m})
}
break;
...
A17.sendMessage(from, { react: { text: "🫡" , key: m.key }})
     ...
     /*     let buttons = [
              ...
              let buttonMessage = {
                  ...
                  caption: `Coffee from Bᴇʟᴜɢᴀ-Bᴏᴛ`,
               /*   footer: `${BotName}`,
                  buttons: buttons,
                  headerType: 4  */
              }
...
└──────────────···▸▸▸`
  ...
  case 'aimenu': case 'ai-menu': case 'aimennu': case 'ai':
        ...
        if (isBanChat) return reply(mess.bangc);
        A17.sendMessage(from, { react: { text: "📕" , key: m.key }})
let aimel ='https://i.ibb.co/qYqxrt8/20231010-232658.png'
  const aimenu = ` 
┌──❖
│Hi 👤
└┬❖   Uꜱᴇʀ :  ${pushname} 
